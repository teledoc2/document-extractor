...
def upload_document(page, document_type: str, document_path: str, timeout: int = 50000) -> bool:
    try:
        ...
        # Use autocomplete by typing the desired document type and hitting Enter.
        # This avoids relying on the dropdown arrow, which can be flaky in headless mode.
        result = type_and_enter_kendo_dropdown(
            page,
            dropdown_input_xpath=document_type_input_xpath,
            value=document_type
        )
        if result:
        ...
        file_input_xpath = '//input[@id="filesvisitregForService"]'
        if find_element_with_fallback(page, file_input_xpath, '//input[@name="filesvisitregForService"]'):
...
FIELD_MAPPING = {
    ...
    "upload_document": {
        "xpath": '//button[@id="uploadDocsForVisit"]',
